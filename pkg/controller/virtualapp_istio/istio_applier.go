...
import (
	...
	istioimpl "github.com/bevyx/remesh/pkg/adapters/istio"
...
//Apply is implementing the Applier interface
func (a *IstioApplier) Apply(virtualApps []remeshv1alpha1.VirtualApp, namespace string) {
	...
	desiredGateways, desiredVirtualServices, desiredDestinationRules := istioimpl.GetDesiredState(virtualApps, namespace)
