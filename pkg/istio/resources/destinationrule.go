...
import (
	istioapi "github.com/bevyx/remesh/pkg/apis/istio/v1alpha3"
	"github.com/bevyx/remesh/pkg/istio"
	metav1 "k8s.io/apimachinery/pkg/apis/meta/v1"
)

func MakeIstioDestinationRule(transformedServices []istio.TransformedService, namespace string, gateway string) *[]istioapi.DestinationRule {
...
func makeDestinationRule(transformedService istio.TransformedService, namespace string, gateway string) *istioapi.DestinationRule {
...
func makeDestinationRuleSpec(transformedService istio.TransformedService) *istioapi.DestinationRuleSpec {
